...
class CL_customerGP(QtWidgets.QDialog):
    ...
    def FN_LOAD_DISPlAY(self):
        filename = self.dirname + '/company.ui'
        ...
        try:
            ...
            self.BTN_searchCustGp_all.clicked.connect(self.FN_GET_ALL)
    ...
    def FN_SEARCH_CUSTGP(self):
        ...
        try:
            ...
            self.custGroup = self.CMB_status.currentText()
    ...
    def FN_MODIFY_CUSTGP(self):
        ...
        if len(self.Qtable_custGP.selectedIndexes()) >0 :
            ...
            custGroup = self.CMB_status.currentText()
            if custGroup == 'Active':
                status = 1
            else:
                status = 0
